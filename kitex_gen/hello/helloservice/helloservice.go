...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	methods := map[string]kitex.MethodInfo{
		...
		"GetByParams": kitex.NewMethodInfo(getByParamsHandler, newHelloServiceGetByParamsArgs, newHelloServiceGetByParamsResult, false),
...
func getByParamsHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*hello.HelloServiceGetByParamsArgs)
	realResult := result.(*hello.HelloServiceGetByParamsResult)
	success, err := handler.(hello.HelloService).GetByParams(ctx, realArg.Data, realArg.Msg)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newHelloServiceGetByParamsArgs() interface{} {
	return hello.NewHelloServiceGetByParamsArgs()
}

func newHelloServiceGetByParamsResult() interface{} {
	return hello.NewHelloServiceGetByParamsResult()
}
...
func (p *kClient) GetByParams(ctx context.Context, data string, msg string) (r *hello.Response, err error) {
	var _args hello.HelloServiceGetByParamsArgs
	_args.Data = data
	_args.Msg = msg
	var _result hello.HelloServiceGetByParamsResult
	if err = p.c.Call(ctx, "GetByParams", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
